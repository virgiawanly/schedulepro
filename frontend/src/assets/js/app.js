...
function updateHorizontalMenus() {
  ...
  if (navbarMenu) {
    ...
    if (dataLayout != 'vertical') document.documentElement.setAttribute('data-sidebar-size', 'lg');
  ...
  if (dataLayout != 'vertical') document.documentElement.removeAttribute('data-sidebar-size');
}
...
function toggleHamburgerMenu() {
  ...
  if (windowSize > 768) document.querySelector('.hamburger-icon').classList.toggle('open');
  ...
  if (currentPath) {
    ...
    if (a) {
      ...
      if (parentCollapseDiv) {
        if (document.documentElement.getAttribute('data-layout') == 'vertical') parentCollapseDiv.classList.remove('hidden');
