...
!(function (n) {
  ...
  function h(t) {
    return (
      (n.href = t), -1 === (t = n.host).indexOf('/') && 0 !== n.pathname.indexOf('/') && (t += '/'), n.protocol + '//' + t + n.pathname + n.search
    );
  }
  ...
  return (
    (e.ext.buttons.print = {
      ...
      action: function (t, e, n, o) {
        ...
        var i = e.buttons.exportData(m.extend({ decodeEntities: !1 }, o.exportOptions)),
        ...
        if (l) {
          ...
          (l.document.body.innerHTML =
            '<h1>' + a.title + '</h1><div>' + (a.messageTop || '') + '</div>' + u + '<div>' + (a.messageBottom || '') + '</div>'),
          ...
          e.buttons.info(
            ...
            e.i18n('buttons.printErrorMsg', 'Please allow popups in your browser for this site to be able to view the print view.'),
            5e3,
          );
      },
      title: '*',
