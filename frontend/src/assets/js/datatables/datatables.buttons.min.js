...
!(function (e) {
  ...
  function B(n, t) {
    ...
    !0 === (t = void 0 === t ? {} : t) && (t = {}),
      ...
      (this.s = { dt: new e.Api(n), buttons: [], listenKeys: '', namespace: 'dtb' + o++ }),
      (this.dom = { container: y('<' + this.c.dom.container.tag + '/>').addClass(this.c.dom.container.className) }),
      this._constructor();
  }
  y.extend(B.prototype, {
    ...
    active: function (t, n) {
      var t = this._nodeToButton(t),
        ...
        o = y(t.node);
      return (
        t.inCollection && this.c.dom.collection.button && this.c.dom.collection.button.active !== w && (e = this.c.dom.collection.button.active),
    ...
    add: function (t, n, e) {
      ...
      return (
        this._expandButton(o, t, t !== w ? t.split : w, (t === w || t.split === w || 0 === t.split.length) && s !== w, !1, n),
        (e !== w && !0 !== e) || this._draw(),
        this
      );
    },
    collectionRebuild: function (t, n) {
      ...
      if (n !== w) {
        ...
        for (
          e.conf.prefixButtons && n.unshift.apply(n, e.conf.prefixButtons), e.conf.postfixButtons && n.push.apply(n, e.conf.postfixButtons), o = 0;
          o < n.length;
          o++
        ) {
          var i = n[o];
    ...
    processing: function (t, n) {
      ...
      return n === w
        ...
        : (y(o.node).toggleClass('processing', n),
          y(e.table().node()).triggerHandler('buttons-processing.dt', [n, e.button(t), e, y(t), o.conf]),
          this);
    },
    remove: function (t) {
    ...
    _constructor: function () {
      var e = this,
        ...
        o = t.settings()[0],
        n = this.c.buttons;
      o._buttons || (o._buttons = []), o._buttons.push({ inst: this, name: this.c.name });
      ...
      t.on('destroy', function (t, n) {
        ...
        y('body').on('keyup.' + this.s.namespace, function (t) {
          ...
          (x.activeElement && x.activeElement !== x.body) ||
            ((n = String.fromCharCode(t.keyCode).toLowerCase()), -1 !== e.s.listenKeys.toLowerCase().indexOf(n) && e._keypress(n, t));
        });
    },
    _addKey: function (t) {
      ...
      for (
        ...
        if (p)
          if (((r = !(!p.config || !p.config.split)), Array.isArray(p)))
            ...
            if (h) {
              if (
                (s !== w && null !== s ? (t.splice(s, 0, h), s++) : t.push(h),
                h.conf.buttons &&
                  ((h.collection = y('<' + c.container.content.tag + '/>')),
                ...
                for (var b = 0; b < h.conf.split.length; b++) {
                  ...
                  'object' == typeof g &&
                    ((g.parent = a),
                    g.collectionLayout === w && (g.collectionLayout = h.conf.collectionLayout),
                    g.dropup === w && (g.dropup = h.conf.dropup),
                    g.fade === w) &&
                    (g.fade = h.conf.fade);
                }
                this._expandButton(h.buttons, h.conf.buttons, h.conf.split, !r, r, s, h.conf);
    ...
    _buildButton: function (n, t, e, o) {
      ...
      if (
        ...
        return (
          (c = y('<' + d.spacer.tag + '/>')
            .addClass('dt-button-spacer ' + n.style + ' ' + d.spacer.className)
            .html(i(n.text))),
          { conf: n, node: c, inserter: c, buttons: [], inCollection: t, isSplit: e, collection: null, textNode: c }
        );
        ...
        : ((a = function (t, n, e, o) {
          ...
          (s = d.liner.tag
            ? ((c = y('<' + d.liner.tag + '/>')
              ...
              'a' === d.liner.tag.toLowerCase() && c.attr('href', '#'),
              l.append(c),
              c)
            : (l.html(i(n.text)), l)),
          ...
          n.config !== w && n.config.split && (n.split = n.config.split));
      var f,
        p,
        h,
        b,
      ...
      return (
        ...
        e &&
          ((p = (f = t ? y.extend(!0, this.c.dom.split, this.c.dom.collection.split) : this.c.dom.split).wrapper),
          (h = y('<' + p.tag + '/>')
          ...
          (m = y('<button class="' + f.dropdown.className + ' dt-button"></button>')
    ...
    _popover: function (o, t, n, e) {
      ...
      !1 === o
        ? i()
        : ((p = y(f.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes())).length && (m.closest(g).length && (m = p.eq(0)), i()),
          ...
          (o = y(o).addClass(b.contentClassName).attr('role', 'menu').appendTo(s)),
          m.attr('aria-expanded', 'true'),
          m.parents('body')[0] !== x.body && (m = x.body.lastChild),
          b.popoverTitle
            ? s.prepend('<div class="dt-button-collection-title">' + b.popoverTitle + '</div>')
            : b.collectionTitle && s.prepend('<div class="dt-button-collection-title">' + b.collectionTitle + '</div>'),
          b.closeButton && s.prepend('<div class="dtb-popover-close">&times;</div>').addClass('dtb-collection-closeable'),
          A(s.insertAfter(m), b.fade),
          (n = y(t.table().container())),
          (d = s.css('position')),
          ('container' !== b.span && 'dt-container' !== b.align) || ((m = m.parent()), s.css('width', n.width())),
          'absolute' === d
            ? ((p = y(m[0].offsetParent)),
              ...
              ('button-right' !== b.align && !s.hasClass(b.rightAlignClassName)) || (c = t.left - u.width + m.outerWidth()),
              ('dt-container' !== b.align && 'container' !== b.align) ||
                ((c = c < t.left ? -t.left : c) + u.width > a.width && (c = a.width - u.width)),
              r.left + c + u.width > y(v).width() && (c = y(v).width() - u.width - r.left),
              n.left + c < 0 && (c = -n.left),
              r.top + p + u.height > y(v).height() + y(v).scrollTop() && (p = t.top - u.height - u.marginTop - u.marginBottom),
              r.top + p < y(v).scrollTop() && (p = t.top + m.outerHeight()),
              s.css({ top: p, left: c }))
            : ((d = function () {
                var t = y(v).height() / 2,
                  n = s.height() / 2;
          ...
          b.background && B.background(!0, b.backgroundClassName, b.fade, b.backgroundHost || m),
          y('div.dt-button-background').on('click.dtb-collection', function () {}),
          b.autoClose &&
            setTimeout(function () {
              ...
              y('body')
                .on('click.dtb-collection', function (t) {
                  ...
                  !h &&
                    ...
                    (!y(t.target).parents()[n]().filter(o).length && !y(e).hasClass('dt-buttons')) || y(t.target).hasClass('dt-button-background')) &&
                    i();
                })
                  ...
                  9 === t.keyCode &&
                    (-1 === n.index(e)
                      ...
                      : t.shiftKey
                        ...
                        : e === n.last()[0] && (n.first().focus(), t.preventDefault()));
                });
          }, 0));
    },
  }),
    (B.background = function (t, n, e, o) {
      e === w && (e = 400),
        (o = o || x.body),
        t
          ? A(y('<div/>').addClass(n).css('display', 'none').insertAfter(o), e)
    ...
    (B.instanceSelector = function (t, i) {
      ...
      return t === w || null === t
        ...
        : ((s = []),
          ...
          (r = function (t) {
            var n;
            if (Array.isArray(t)) for (var e = 0, o = t.length; e < o; e++) r(t[e]);
            else
              'string' == typeof t
                ? -1 !== t.indexOf(',')
                  ? r(t.split(','))
                  : -1 !== (n = y.inArray(t.trim(), a)) && s.push(i[n].inst)
                : 'number' == typeof t
                  ? s.push(i[t].inst)
        ...
        var c = [],
          u = function (t, n, e) {
            for (var o, i, s = 0, a = n.length; s < a; s++)
              (o = n[s]) && (t.push({ node: o.node, name: o.conf.name, idx: (i = e !== w ? e + s : s + '') }), o.buttons) && u(t, o.buttons, i + '-');
          },
          d = function (t, n) {
            var e = [],
              o =
            ...
            if (Array.isArray(t) || t instanceof y) for (s = 0, a = t.length; s < a; s++) d(t[s], n);
            else if (null === t || t === w || '*' === t) for (s = 0, a = e.length; s < a; s++) c.push({ inst: n, node: e[s].node });
            else if ('number' == typeof t) n.s.buttons[t] && c.push({ inst: n, node: n.s.buttons[t].node });
            else if ('string' == typeof t)
              if (-1 !== t.indexOf(',')) for (var i = t.split(','), s = 0, a = i.length; s < a; s++) d(i[s].trim(), n);
              else if (t.match(/^\d+(\-\d+)*$/)) {
                var r = y.map(e, function (t) {
                  return t.idx;
                });
                c.push({ inst: n, node: e[y.inArray(t, r)].node });
              } else if (-1 !== t.indexOf(':name')) {
                var l = t.replace(':name', '');
                for (s = 0, a = e.length; s < a; s++) e[s].name === l && c.push({ inst: n, node: e[s].node });
              } else
                y(o)
                  .filter(t)
                  .each(function () {
            ...
            else 'object' == typeof t && t.nodeName && -1 !== (r = y.inArray(t, o)) && c.push({ inst: n, node: o[r] });
          },
          e = 0,
          o = t.length;
        e < o;
    ...
    (B.stripData = function (t, n) {
      return (
        'string' == typeof t &&
          ((t = (t = t.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '')).replace(/<!\-\-.*?\-\->/g, '')),
    ...
    (B.defaults = {
      ...
      dom: {
        ...
        collection: {
          action: { dropHtml: '<span class="dt-button-down-arrow">&#x25BC;</span>' },
          container: { className: 'dt-button-collection', content: { className: '', tag: 'div' }, tag: 'div' },
        },
        button: {
          tag: 'button',
          className: 'dt-button',
        ...
        split: {
          action: { className: 'dt-button-split-drop-button dt-button', tag: 'button' },
          dropdown: {
            align: 'split-right',
    ...
    e.Api.register('buttons().containers()', function () {
      ...
      return (
        this.iterator(!0, 'table', function (t) {
          if (t._buttons) for (var n = B.instanceSelector(s, t._buttons), e = 0, o = n.length; e < o; e++) i = i.add(n[e].container());
        }),
        i
      );
    }),
    ...
    e.Api.register('button().add()', function (t, n, e) {
      var o = this.context;
      return (
        o.length && (o = B.instanceSelector(this._groupSelector, o[0]._buttons)).length && o[0].add(n, t, e), this.button(this._groupSelector, t)
      );
    }),
      ...
      return (
        !1 === t
          ? (this.off('destroy.btn-info'),
            ...
            (i = null))
          : (i && clearTimeout(i),
            y('#datatables_buttons_info').length && y('#datatables_buttons_info').remove(),
            (t = t ? '<h2>' + t + '</h2>' : ''),
            A(
              y('<div id="datatables_buttons_info" class="dt-button-info"/>')
                .html(t)
                .append(y('<div/>')['string' == typeof n ? 'html' : 'append'](n))
                .css('display', 'none')
                .appendTo('body'),
            ),
            e !== w &&
  ...
  var i,
    n = function (t) {
      var n;
      return (n =
        'function' == typeof (n = '*' === t.filename && '*' !== t.title && t.title !== w && null !== t.title && '' !== t.title ? t.title : t.filename)
          ? n()
          : n) === w || null === n
        ? null
        : (n = (n = -1 !== n.indexOf('*') ? n.replace('*', y('head > title').text()).trim() : n).replace(
            /[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g,
            '',
          )) + (s(t.extension) || '');
    },
    ...
    r = function (t, n, e) {
      ...
      return null === n
        ? null
        : ((t = y('caption', t.table().container()).eq(0)), '*' === n ? (t.css('caption-side') !== e ? null : t.length ? t.text() : '') : n);
    },
    l = y('<textarea/>')[0],
    c = function (e, t) {
      for (
        var o = y.extend(
          ...
          i =
            (e.select &&
              ...
              i.selected === w &&
              e.rows(o.rows, y.extend({ selected: !0 }, i)).any() &&
