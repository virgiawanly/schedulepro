...
!(function (n) {
  ...
  'function' == typeof define && define.amd
    ? define(['jquery', 'datatables.net', 'datatables.net-buttons'], function (t) {
  ...
  function f() {
    ...
    return (
      ...
      !!((t = navigator.userAgent.match(/AppleWebKit\/(\d+\.\d+)/)) && 1 < t.length && +t[1] < 603.1)
    );
  }
  var O = (function (d) {
              ...
              s
                ...
                : (m || (e && f)) && d.FileReader
                  ? (((n = new FileReader()).onloadend = function () {
                    ...
                    n.readAsDataURL(t),
                    (r.readyState = r.INIT))
                  : ((l = l || p().createObjectURL(t)), (!e && d.open(l, '_blank')) || (d.location.href = l), (r.readyState = r.DONE), a(), u(l));
          }).prototype),
    ...
    (n.ext.buttons.copyHtml5 = {
      ...
      action: function (t, e, o, l) {
        ...
        var n = this,
          ...
          d = c(l),
          p = r.str,
          i = C('<div/>').css({ height: 1, width: 1, overflow: 'hidden', position: 'fixed', top: 0, left: 0 }),
          d =
            ...
            if ((i.remove(), s))
              return (
                e.buttons.info(
                  ...
                  e.i18n('buttons.copySuccess', { 1: 'Copied one row to clipboard', _: 'Copied %d rows to clipboard' }, r.rows),
                  2e3,
                ),
    ...
    (n.ext.buttons.excelHtml5 = {
      ...
      action: function (t, e, o, s) {
          ...
          for (var e = 0, o = t.length; e < o; e++) {
            ...
            for (var a = 0, d = R.length; a < d; a++) {
              ...
              if (t[e].match && !t[e].match(/^0\d+/) && t[e].match(p.match)) {
                ...
                p.fmt && (i = p.fmt(i)), (n = E(u, 'c', { attr: { r: l, s: p.style }, children: [E(u, 'v', { text: i })] }));
                break;
              }
            }
            (n =
              n ||
              ('number' == typeof t[e] || (t[e].match && t[e].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) && !t[e].match(/^0\d+/))
                ? E(u, 'c', { attr: { t: 'n', r: l }, children: [E(u, 'v', { text: t[e] })] })
                : ((r = r.replace ? r.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '') : r),
                  E(u, 'c', {
                    attr: { t: 'inlineStr', r: l },
                    children: { row: E(u, 'is', { children: { row: E(u, 't', { text: r, attr: { 'xml:space': 'preserve' } }) } }) },
                  })))),
              m.appendChild(n);
          }
          c.appendChild(m), y++;
        ...
        function r(t, e) {
          ...
          o[0].appendChild(E(u, 'mergeCell', { attr: { ref: 'A' + t + ':' + z(e) + t } })),
                  ...
                  for (var l = 0, n = t.body.length; l < n; l++) {
                    ...
                    if (
                      ...
                      (o =
                        o <
                        (r = (
                          -1 !== (a = null !== a && a !== k ? a.toString() : '').indexOf('\n')
                            ? ((r = a.split('\n')).sort(function (t, e) {
        ...
        C('sheets sheet', w).attr('name', N(s)),
          s.autoFilter &&
            (C('mergeCells', u).before(E(u, 'autoFilter', { attr: { ref: 'A' + F + ':' + z(i.header.length - 1) + a } })),
        ...
        var w = new (S())(),
          F = { compression: 'DEFLATE', type: 'blob', mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' },
          B =
            (!(function s(f, t) {
              D === k &&
                (D = -1 === A.serializeToString(new T.DOMParser().parseFromString(_['xl/worksheets/sheet1.xml'], 'text/xml')).indexOf('xmlns:r')),
                  ...
                  if (C.isPlainObject(e)) s(f.folder(t), e);
                    ...
                    if (D) {
                      for (var o, l = e.childNodes[0], n = [], r = l.attributes.length - 1; 0 <= r; r--) {
                        ...
                        -1 !== a.indexOf(':') && (n.push({ name: a, value: d }), l.removeAttribute(a));
                      }
                    ...
                    var i = A.serializeToString(e),
                      i = (i = D
                        ? (i = (i = -1 === i.indexOf('<?xml') ? '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + i : i).replace(
                            /_dt_b_namespace_token_/g,
                            ':',
                          )).replace(/xmlns:NS[\d]+="" NS[\d]+:/g, '')
                        : i).replace(/<([^<>]*?) xmlns=""([^<>]*?)>/g, '<$1 $2>');
                    f.file(t, i);
                  }
                });
            })(w, p),
    ...
    (n.ext.buttons.pdfHtml5 = {
      ...
      action: function (t, e, o, l) {
        ...
        for (var d = 0, p = n.body.length; d < p; d++)
          a.push(
            C.map(n.body[d], function (t) {
              return { text: 'string' == typeof (t = null !== t && t !== k ? t : '') ? t : t + '', style: d % 2 ? 'tableBodyEven' : 'tableBodyOdd' };
            }),
          );
        l.footer &&
          n.footer &&
        ...
        var i = {
          ...
          e =
            (r.messageTop && i.content.unshift({ text: r.messageTop, style: 'message', margin: [0, 0, 0, 12] }),
            r.messageBottom && i.content.push({ text: r.messageBottom, style: 'message', margin: [0, 0, 0, 12] }),
            r.title && i.content.unshift({ text: r.title, style: 'title', margin: [0, 0, 0, 12] }),
