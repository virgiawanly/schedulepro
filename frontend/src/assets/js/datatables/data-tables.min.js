...
!(function (n) {
  ...
  function l(t, e, n) {
    var a = typeof t,
      r = 'string' == a;
    return (
      'number' == a || 'bigint' == a || !!h(t) || (e && r && (t = $(t, e)), n && r && (t = t.replace(q, '')), !isNaN(parseFloat(t)) && isFinite(t))
    );
  }
  function a(t, e, n) {
    var a;
      ...
      (v = t),
        ...
        (this.fnGetData = function (t, e) {
          var n,
            a = this.api(!0);
          return t !== H
            ? ((n = t.nodeName ? t.nodeName.toLowerCase() : ''), e !== H || 'td' == n || 'th' == n ? a.cell(t, e).data() : a.row(t).data() || null)
            : a.data().toArray();
        }),
          ...
          if ('table' != this.nodeName.toLowerCase()) W(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
            ...
            var S = h.oFeatures,
              t = function () {
                ...
                if (
                  (0 ===
                    (n = 0 === n.length && 0 < e.length && ('' !== h.oScroll.sX || '' !== h.oScroll.sY) ? P('<tfoot/>').appendTo(l) : n).length ||
                  0 === n.children().length
    ...
    for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = w.ext.type.detect, f = 0, d = s.length; f < d; f++)
      if (((l = []), !(o = s[f]).sType && o._sManualType)) o.sType = o._sManualType;
        ...
        for (e = 0, n = c.length; e < n; e++) {
          for (
            a = 0, r = u.length;
            a < r && (l[a] === H && (l[a] = S(t, a, f, 'type')), (i = c[e](l[a], t)) || e === c.length - 1) && ('html' !== i || h(l[a]));
            a++
          );
          if (i) {
            o.sType = i;
  ...
  function st(t, e, n, a) {
    ...
    if (e)
      for (r = e.length - 1; 0 <= r; r--)
        for (
          var u,
            c = (u = e[r]).target !== H ? u.target : u.targets !== H ? u.targets : u.aTargets,
            f = 0,
      ...
      return (
        t.iDrawError != r &&
          ...
          (W(
            t,
            0,
            'Requested unknown parameter ' + ('function' == typeof o.mData ? '{function}' : "'" + o.mData + "'") + ' for row ' + e + ', column ' + n,
            4,
          ),
          (t.iDrawError = r)),
        l
  ...
  function Tt(r, t, n) {
    ...
    var a,
      ...
      u =
        (P.isPlainObject(l) &&
          l.data &&
          ((u = 'function' == typeof (i = l.data) ? i(t, r) : i), (t = 'function' == typeof i && u ? u : P.extend(!0, t, u)), delete l.data),
        {
          data: t,
          success: e,
          dataType: 'json',
  ...
  function Lt(n) {
    function e(t) {
      ...
      (o.return && 'Enter' !== t.key) ||
        (e != o.sSearch &&
          (Rt(n, { sSearch: e, bRegex: o.bRegex, bSmart: o.bSmart, bCaseInsensitive: o.bCaseInsensitive, return: o.return }),
          (n._iDisplayStart = 0),
          y(n)));
    }
    var t = n.oClasses,
  ...
  function Ht(t, e, n, a, r, o) {
    ...
    if ((0 !== w.ext.search.length && (n = !0), (l = Wt(t)), e.length <= 0)) t.aiDisplay = o.slice();
      ...
      for (
        (l || n || a || r.length > e.length || 0 !== e.indexOf(r) || t.bSorted) && (t.aiDisplay = o.slice()), i = t.aiDisplay, s = 0;
        s < i.length;
        s++
      )
    ...
    for (var e = t.aoColumns, n = I(t), a = t.oLanguage.oAria, r = 0, o = e.length; r < o; r++) {
      ...
      u.removeAttribute('aria-sort'),
        (i = i.bSortable
          ? s +
            ('asc' ===
            ((0 < n.length && n[0].col == r && (u.setAttribute('aria-sort', 'asc' == n[0].dir ? 'ascending' : 'descending'), l[n[0].index + 1])) ||
              l[0])
              ? a.sSortAscending
              : a.sSortDescending)
          : s),
  ...
  function R(n, t, e, a) {
    ...
    return (
      ...
      null !== e &&
        ((t = P.Event(e + '.dt')), (e = P(n.nTable)).trigger(t, a), 0 === e.parents('body').length && P('body').trigger(t, a), r.push(t.result)),
      r
    );
  }
  function Se(t) {
    ...
    function i(t, e) {
      ...
      if (Array.isArray(t) || t instanceof P) for (var a = 0, r = t.length; a < r; a++) i(t[a], e);
        ...
        t.nodeName && 'tr' === t.nodeName.toLowerCase()
          ? l.push(t)
          : ((n = P('<tr><td></td></tr>').addClass(e)), (P('td', n).addClass(e).html(t)[0].colSpan = T(o)), l.push(n[0]));
    }
    var l = [];
  ...
  var Ie = [],
    ...
    Fe =
      ...
      P.extend(B.prototype, {
        ...
        iterator: function (t, e, n, a) {
          ...
          return d.length || a
            ? (((t = (a = new B(h, t ? d.concat.apply([], d) : d)).selector).rows = p.rows), (t.cols = p.cols), (t.opts = p.opts), a)
            : this;
        },
        lastIndexOf:
          o.lastIndexOf ||
    ...
    Re = function (t, e) {
      ...
      n.length &&
        ...
        e._details &&
        (e._details.remove(), (e._detailsShow = H), (e._details = H), P(e.nTr).removeClass('dt-hasChild'), Le(n));
    },
    Pe = 'row().child',
    je = Pe + '()',
    He =
      (e(je, function (t, e) {
        ...
        return t === H
          ? n.length && this.length
            ...
            : H
          : (!0 === t ? this.child.show() : !1 === t ? Re(this) : n.length && this.length && Te(n[0], n[0].aoData[this[0]], t, e), this);
      }),
    ...
    Ne =
                    ...
                    function (t) {
                      ...
                      if (null === t || t === H || n) {
                        for (o = [], i = 0, l = d.length; i < l; i++)
                          for (r = d[i], s = 0; s < p; s++)
                            (u = { row: r, column: s }), (!n || ((c = f[r]), t(u, S(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                        return o;
                      }
      ...
      t('columns().search()', 'column().search()', function (a, r, o, i) {
        return this.iterator('column', function (t, e) {
          ...
          t.oFeatures.bFilter &&
            (P.extend(n[e], { sSearch: a + '', bRegex: null !== r && r, bSmart: null === o || o, bCaseInsensitive: null === i || i }),
      ...
      (w.defaults = {
        ...
        fnStateLoadCallback: function (t) {
          try {
            return JSON.parse(
              (-1 === t.iStateDuration ? sessionStorage : sessionStorage).getItem('DataTables_' + t.sInstance + '_' + location.pathname),
            );
          } catch (t) {
            return {};
          }
        ...
        fnStateSaveCallback: function (t, e) {
          try {
            (-1 === t.iStateDuration ? sessionStorage : sessionStorage).setItem(
    ...
    return (
      e <= a
        ...
        : t <= r
          ...
          : ((e - 1 - r <= t ? (n = f(e - (a - 2), e)) : ((n = f(t - r + 2, t + r - 1)).push('ellipsis'), n.push(e - 1), n)).splice(0, 0, 'ellipsis'),
            n.splice(0, 0, 0)),
      (n.DT_el = 'span'),
      n
    );
  ...
  function ke(t, e, n, a) {
    ...
    return 0 === t || (t && '-' !== t)
      ? 'number' == (r = typeof t) || 'bigint' == r
        ? t
        : +(t = (t = e ? $(t, e) : t).replace && (n && (t = t.replace(n, '')), a) ? t.replace(a, '') : t)
      : -1 / 0;
  }
  function Me(n) {
    P.each(
  ...
  function Ue(t, e, n) {
    ...
    if (j.moment) {
      ...
      e
        ? (Be || alert('DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17'), (Be = !0))
        : (a = new Date(t));
    return a;
  }
  function Ve(s) {
        ...
        function (t, e) {
          ...
          return (
            (null !== t && t !== H) ||
              (t =
                '--now' === i
                  ? ((n = new Date()), new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds())))
                  : ''),
            'type' === e
              ? l
              : '' === t
                ...
                : !(null === r || a !== r || 'sort' === e || 'type' === e || t instanceof Date) || null === (n = Ue(t, a, o))
                  ...
                  : 'sort' === e
                    ? n
                    : ((t = null === r ? Ee(n, 'toDate', 'toJSDate', '')[s]() : Ee(n, 'format', 'toFormat', 'toISOString', r)),
                      'display' === e ? We(t) : t)
          );
        }
      );
