...
if (document.getElementById('sa-error'))
  document.getElementById('sa-error').addEventListener('click', function () {
    Swal.fire({
      ...
      buttonsStyling: false,
      footer:
        '<a href="javascript:void(0);" class="inline-flex items-center gap-2 mt-3 text-base font-medium text-custom-400 hover:text-custom-600">Why do I have this issue?</a>',
      showCloseButton: true,
    });
  });
