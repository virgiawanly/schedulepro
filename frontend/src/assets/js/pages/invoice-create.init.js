  ...
  var delLink =
    ...
    `" class="px-3.5 py-2.5 border-none form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Description (Optional)" required>
                ...
                <td class="border border-slate-200 dark:border-zink-500 px-3.5 py-1.5 text-center">
                    <button type="button" class="px-2 py-1.5 text-xs text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100 dark:bg-red-500/20 dark:text-red-500 dark:hover:bg-red-500 dark:hover:text-white dark:focus:bg-red-500 dark:focus:text-white dark:active:bg-red-500 dark:active:text-white dark:ring-red-400/20 product-removal"><lucide-angular name="trash-2" class="inline-block size-3 mr-1 align-middle"></i> <span class="align-middle">Delete</span></button>
                </td>
...
function billingFunction() {
  if (document.getElementById('customSoftSwitch').checked) {
    document.getElementById('fullNameBillingInput').value = document.getElementById('fullNameShippingInput').value;
    document.getElementById('phoneNoBillingInput').value = document.getElementById('phoneNoShippingInput').value;
    document.getElementById('alternativeNoBillingInput').value = document.getElementById('alternativeNoShippingInput').value;
    document.getElementById('taxBillingInput').value = document.getElementById('taxShippingInput').value;
    document.getElementById('addressBillingInput').value = document.getElementById('addressShippingInput').value;
  } else {
