  ...
  form.addEventListener(
    ...
    function (event) {
      if (!form.checkValidity()) {
        ...
        event.preventDefault();
        if (customerNameField.value !== '' && emailField.value !== '' && dateField.value !== '' && phoneField.value !== '' && !editlist) {
          customerList.add({
        ...
        } else if (customerNameField.value !== '' && emailField.value !== '' && dateField.value !== '' && phoneField.value !== '' && editlist) {
  ...
  if (ids_array.length > 0) {
    if (confirm('Are you sure you want to delete this?')) {
      ids_array.forEach(function (id) {
        ...
        customerList.remove('id', `<a href="javascript:void(0);" class="fw-medium id">${id}</a>`);
      });
