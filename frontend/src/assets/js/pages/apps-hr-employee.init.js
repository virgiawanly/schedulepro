...
//product list Table
var options = {
  valueNames: ['ID', 'Name', 'Role', 'Email', 'Phone', 'Country', 'Experience', 'JoinDate', 'Action'],
  page: 7,
  pagination: true,
  plugins: [
    ListPagination({
...
var employeeTable = new List('employeeTable', options).on('updated', function (list) {
  ...
  document.querySelector('.pagination-next').addEventListener('click', function () {
    document.querySelector('.pagination.listjs-pagination')
      ? document.querySelector('.pagination.listjs-pagination').querySelector('.active') &&
        document.querySelector('.pagination.listjs-pagination').querySelector('.active').nextElementSibling != null
  ...
  document.querySelector('.pagination-prev').addEventListener('click', function () {
    document.querySelector('.pagination.listjs-pagination')
      ? document.querySelector('.pagination.listjs-pagination').querySelector('.active') &&
        document.querySelector('.pagination.listjs-pagination').querySelector('.active').previousSibling != null
...
function loadFileData(datas) {
  ...
  Array.from(datas).forEach(function (element, index) {
    cnt++;
    employeeTable.add({
      ID: `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">${element.ID}</a>`,
      Name:
        `<a href="javascript:void(0);" class="flex items-center gap-3">
                <div div class="size-6 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                    <img src="` +
        element.img +
      ...
      Action: `<div class="flex gap-3">
                        <a class="flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500" routerLink="/pages-account"><lucide-angular name="eye" class="inline-block size-3"></i> </a>
                        <a href="javascript:void(0);" data-modal-target="addEmployeeModal" class="edit-item-btn flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><lucide-angular name="pencil" class="size-4"></i></a>
                        <a href="javascript:void(0);" data-modal-target="deleteModal" class="remove-item-btn flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"><lucide-angular name="trash-2" class="size-4"></i></a>
                    </div>`,
    });
    //data init end
  ...
  employeeTable.remove(
    'ID',
    `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">#TWE1001501</a>`,
  );
...
function refreshCallbacks() {
  ...
  Array.from(document.querySelectorAll('.edit-item-btn')).forEach(function (elem) {
    elem.addEventListener('click', function (e) {
      ...
      var itemValues = employeeTable.get({
        id: `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">` + itemId + `</a>`,
      });
  ...
  Array.from(document.querySelectorAll('.remove-item-btn')).forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      var itemValues = employeeTable.get({
        id:
          `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">` +
          removeitemId +
          `</a>`,
      });
      Array.from(itemValues).forEach(function (x) {
        ...
        console.log('+++ ', isdeleteid, removeitemId);
  ...
  form.addEventListener('submit', function (event) {
    ...
    if (!editList && allFieldsValid) {
      ...
      employeeTable.add({
        ...
        Name:
          `<a href="javascript:void(0);" class="flex items-center gap-3">
                            <div div class="size-6 rounded-full shrink-0 bg-slate-100">
      ...
      var editValues = employeeTable.get({
        ID: `<a href="javascript:void(0);" class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600">` + idInput + `</a>`,
      });
